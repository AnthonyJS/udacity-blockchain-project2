...
contract StarNotary is ERC721 {
    ...
    string public name = "Super Star Token";
    ...
    function exchangeStars(uint256 _tokenId1, uint256 _tokenId2) public {
        ...
        require(ownerToken1 == msg.sender || ownerToken2 == msg.sender, "The sender must be the owner of either token1 or token2");
    ...
    function transferStar(address _to1, uint256 _tokenId) public {
        ...
        require(ownerOf(_tokenId) == msg.sender, "You can't transfer a Star that you don't own");
